...
session_start();
$_SESSION['pagina_anterior'] = 'resgate_item4';
    ...
    <main>
        <form id="resgateForm" action="codigo.php" method="POST">
            ...
            <div class="container">
                ...
                <div class="detalhes">
                    <h2>Cupom para assistência técnicas - 5%</h2>
                    <p>3.500 pontos</p>
                    <p>Pontos: <span id="points">
                            <?= number_format($pontos, 0, ',', '.') ?> de 3.500
                        </span></p>
                    <div class="progress-bar">
                        <div class="progress" id="progress" style="width: <?= ($pontos / 3500 * 100) ?>%;"></div>
                    </div>
                    <div class="btn">
