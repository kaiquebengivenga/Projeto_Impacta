...
session_start();
$_SESSION['pagina_anterior'] = 'resgate_item8';
    ...
    <main>
        <form id="resgateForm" action="codigo.php" method="POST">
            ...
            <div class="container">
                ...
                <div class="detalhes">
                    <h2>Cupom para materiais escolares - 10%</h2>
                    <p>5.000 pontos</p>
                    <p>Pontos: <span id="points">
                            <?= number_format($pontos, 0, ',', '.') ?> de 5.000
                        </span></p>
                    <div class="progress-bar">
                        <div class="progress" id="progress" style="width: <?= ($pontos / 5000 * 100) ?>%;"></div>
                    </div>
                    <div class="btn">
