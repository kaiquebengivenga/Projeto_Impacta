...
session_start();
$_SESSION['pagina_anterior'] = 'resgate';
...
<body>
    ...
    <main>
        <form id="resgateForm" action="codigo.php" method="POST">
            ...
            <div class="container">
                <img src="imagens/cupom_5.png" alt="">
                <div class="detalhes">
                    <h2>Cupom para loja de roupas - 5%</h2>
                    <p>3.000 pontos</p>
                    <p>Pontos: <span id="points">
                            <?php echo number_format($pontos, 0, ',', '.'); ?> de 3.000
                        </span></p>
                    <div class="progress-bar">
                        <div class="progress" id="progress" style="width: <?php echo $pontos / 3000 * 100; ?>%;"></div>
                    </div>
                    <div class="btn">
                    ...
                    <div class="mais_detalhes">
                        ...
                        <ul>
                            ...
                            <li>Duração de 15 dias após o resgate;</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="pop-up">
                ...
                ?>
                    <div class="card-pop-up" id="popUpErro">
                        <button type="button" class="fechar" id="fecharErro" ><img src="imagens/x.png" alt=""></box-icon></button>
