...
session_start();
$_SESSION['pagina_anterior'] = 'resgate_item7';
    ...
    <main>
        <form id="resgateForm" action="codigo.php" method="POST">
            ...
            <div class="container">
                ...
                <div class="detalhes">
                    <h2>Cupom para loja de tênis - 5%</h2>
                    <p>3.000 pontos</p>
                    <p>Pontos: <span id="points">
                            <?= number_format($pontos, 0, ',', '.') ?> de 3.000
                        </span></p>
                    <div class="progress-bar">
                        <div class="progress" id="progress" style="width: <?= ($pontos / 3000 * 100) ?>%;"></div>
                    </div>
                    <div class="btn">
                    ...
                    <div class="mais_detalhes">
                        ...
                        <ul>
                            <li>Minímo de R$ 100,00 para a utilização do desconto na hora da compra;</li>
