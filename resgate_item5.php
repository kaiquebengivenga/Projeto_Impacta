...
session_start();
$_SESSION['pagina_anterior'] = 'resgate_item5';
    ...
    <main>
        <form id="resgateForm" action="codigo.php" method="POST">
            ...
            <div class="container">
                ...
                <div class="detalhes">
                    <h2>Cupom para faculdades pagas - 10%</h2>
                    <p>8.000 pontos</p>
                    <p>Pontos: <span id="points">
                            <?= number_format($pontos, 0, ',', '.') ?> de 8.000
                        </span></p>
                    <div class="progress-bar">
                        <div class="progress" id="progress" style="width: <?= ($pontos / 8000 * 100) ?>%;"></div>
                    </div>
                    <div class="btn">
                    ...
                    <div class="mais_detalhes">
                        ...
                        <ul>
                            ...
                            <li class="atencao"><img src="imagens/perigo.png" alt="">Este item só será utilizado após o
                                período escolar</li>
                        </ul>
                    </div>
                </div>
